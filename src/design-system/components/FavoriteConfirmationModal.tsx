          ...
          <TouchableWithoutFeedback onPress={() => {}}>
            <View style={[styles.modalContainer, { backgroundColor: ds.colors.surface }]}>
              ...
              <View style={styles.header}>
                <View style={[styles.iconContainer, { backgroundColor: isFavorite ? '#EF4444' : ds.colors.primary }]}>
                  <Ionicons 
                ...
                <Text style={[styles.title, { color: ds.colors.text.primary }]}>
                  {isFavorite ? t('favorites.removeTitle') : t('favorites.addTitle')}
                </Text>
              </View>
              ...
              <View style={styles.content}>
                <Text style={[styles.message, { color: ds.colors.text.secondary }]}>
                  {isFavorite 
                    ? t('favorites.removeMessage').replace('{{name}}', friendName)
                    : t('favorites.addMessage').replace('{{name}}', friendName)
                  }
                </Text>
              ...
              <View style={styles.actions}>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    { 
                      backgroundColor: isFavorite ? '#EF4444' : ds.colors.primary,
